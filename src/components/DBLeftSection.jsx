...
const DBLeftSection = () => {
  return (
    <div className="h-full py-12 flex flex-col bg-gray-100 backdrop-blur-md shadow-md min-w-210 w-300 gap-3">
      ...
      <div className="w-full items-center justify-cenyer flex h-225 mt-auto px-2">
